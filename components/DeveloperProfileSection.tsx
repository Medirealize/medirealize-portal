...
export default function DeveloperProfileSection() {
  return (
    <section className="border-y border-[#DADDE1] bg-white py-10 sm:py-12" aria-label="Profile">
      <div className="mx-auto max-w-6xl px-4">
        <div className="grid grid-cols-1 items-start gap-6 sm:gap-8 lg:grid-cols-[minmax(0,auto)_1fr] lg:gap-10">
          ...
          <div className="min-w-0">
            <h2 className="text-xl font-bold leading-snug tracking-tight text-[#050505] sm:text-2xl">
              プロフィール：医師としての「背骨」と、開発への「想い」
            </h2>

            <div className="mt-4 space-y-4 text-sm leading-relaxed text-[#65676B] sm:mt-3 sm:text-[0.95rem]">
              <section>
                <h4 className="text-base font-semibold text-[#050505]">
                  ■ 「現場」を、誰よりも見てきた。
                </h4>
                <p className="mt-2 text-[#1C1E21]">
              ...
              <section className="rounded-lg border border-[#DADDE1] bg-[#F0F2F5] p-4 shadow-[0_1px_2px_rgba(0,0,0,0.05)] sm:p-4">
                <h4 className="text-base font-semibold text-[#050505]">■ 略歴</h4>
                <ul className="mt-2 space-y-1.5 text-[#1C1E21]">
                ...
                <div className="mt-3 border-t border-[#DADDE1] pt-3">
                  ...
                  <p className="mt-1.5 text-xs leading-relaxed text-[#65676B]">
